    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <img
              data-v-78fee962=""
              src="https://mt-sportradar.com/assets/images/regions/20000000003319.png"
              alt=""
            />
          </div>
          <div
        ...
        >
          <div
            ...
            style={{ flexDirection: "row" }}
          >
            <span data-v-ee8420c2="" className="text-level-11 text">
              Home Team
            </span>{" "}
            <span data-v-ee8420c2="" className="text-level-11 text">
              Draw
      ...
      >
        <div
          ...
          style={{ flexDirection: "row" }}
        >
          <div data-v-ee8420c2="" className="date column">
            <div
              data-v-ee8420c2=""
              className="day row"
              style={{ flexDirection: "row" }}
          ...
          <div data-v-ee8420c2="" className="team column">
            <div
              data-v-ee8420c2=""
              className="row"
              style={{ flexDirection: "row" }}
            >
              <span data-v-ee8420c2="" className="text">
                LGD Goose
              </span>
            </div>
            <div
